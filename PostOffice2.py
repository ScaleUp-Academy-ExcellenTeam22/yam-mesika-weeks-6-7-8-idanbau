...
class Message:
    def __init__(self, message_id, title, body, sender, from_me: bool, read: bool):
        """
        :param message_id: id of the messages
        :param title: Message title
        :param body: Message body
        :param sender: Message sender
        :param from_me: Send or received
    ...
    def __str__(self):
        """
        :return: Represent of message
        """
        return f"""id: {self.id}
        {"To" if self.from_me else "From"}: {self.sender}
        Title: {self.title}
        Message: {self.body}
        """
